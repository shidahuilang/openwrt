...
uci set network.lan.dns='119.29.29.29 114.114.114.114'           # DNS(多个DNS要用空格分开)
...
sed -i 's/luci-theme-bootstrap/luci-theme-neobird2/g' feeds/luci/collections/luci/Makefile
...
# x86机型,默认内核5.10，修改内核为5.15（源码时时变,自行根据target/linux/x86/Makefile文件修改）
